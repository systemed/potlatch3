package net.systemeD.potlatch2 {
	...
	import net.systemeD.potlatch2.RemoteControl;
    ...
    * buried in various ControllerState classes. */
    public class EditController extends EventDispatcher implements MapController {
		...
		public var palette:TasksPalette;
        ...
        public function EditController(map:Map, tagViewer:TagViewer, toolbox:Toolbox) {
			...
			webserver.listen(8111, function(error:Error, message:String):void {
				setTimeout(function():void {
					dispatchEvent(new AttentionEvent(AttentionEvent.ALERT, null, "Remote Control connection couldn't start"));
				}, 3000);
			});
			webserver.registerController(new RemoteControl(this));
        ...
        *   @param newState The ControllerState to switch to. */
		...
		/** Open/close tasks palette */

		public function openPalette():void { palette.visible=true; }
		public function closePalette():void { palette.visible=false; }
