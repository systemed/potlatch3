package net.systemeD.potlatch2 {
    ...
    public class Preloader extends net.systemeD.potlatch2.PreloaderDisplayBase {
        ...
        override public function initialize():void
        {
			...
			// request .zip files
			var assets:String = "assets/icons.zip=icons/;assets/features_pois.zip=features/pois/"; // loaderInfo.parameters['assets']
			if (assets) {
				for each (var file:String in assets.split(';')) {
		...
		private function zebraHandler(e:Event):void {
			if (_IsInitComplete) {
				...
				bar.graphics.endFill();
				offset=(offset+1) % 25;
				stageWidth = stage.nativeWindow.width;
				stageHeight = stage.nativeWindow.height;
