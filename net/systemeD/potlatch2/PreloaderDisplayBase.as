package net.systemeD.potlatch2
{
    ...
    public class PreloaderDisplayBase extends Sprite implements IPreloaderDisplay
    {
        ...
        virtual public function set preloader(value:Sprite):void
        {
			...
			trace(this.stage.nativeWindow.bounds.width);
        ...
        virtual public function set stageHeight(height:Number):void { trace("setting h"+height+" / "+stageHeight); _stageHeight = height; }
        virtual public function get stageHeight():Number { trace("getting h"); return _stageHeight; }

        protected var _stageWidth:Number = 400;
        virtual public function set stageWidth(width:Number):void { trace("setting w"+width+" / "+stageWidth); _stageWidth = width; }
        virtual public function get stageWidth():Number { trace("getting w"); return _stageWidth; }
